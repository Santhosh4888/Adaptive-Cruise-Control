...
def main():
    ...
    for i in range(len(CP.Drs)):
        upper_controller = Controller.MPC()                                # The Upper Controller        
        ...
        ego = Kinematics.kinematics_1()                                    # For setting the kinematics equations of the ego vehicle 
        if i == 0:
            pre = Kinematics.kinematics_2(CP.Drs[i] + 10)                  # For setting the kinematics equations of the preceeding vehicle
        else:
            pre = Kinematics.kinematics_2(CP.Drs[i] + 25)                  # For setting the kinematics equations of the preceeding vehicle
...
if __name__ == '__main__':
    store_seperations, store_acceleration, store_velocities, store_time = main()
    print("Program ended")