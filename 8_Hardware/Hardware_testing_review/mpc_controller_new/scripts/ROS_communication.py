...
class Communication:
    ...
    # def start_subscribers(self, use_imu=False):
    #     if odomenu:
    #         rospy.Subscriber("/fixposition/odometry_enu", Odometry, self.imu_callback, queue_size=10)
    #     else:
    #         rospy.Subscriber("/velocity_feedback", Float32, self.velocity_callback, queue_size=10)
    ...
    # self.ego_vel = msg.twist.twist.linear.x  # Longitudinal velocity
