...
Dr_3 = 40.0                                                                        # Radar measured Distance (Initial Seperation) (Scenario 3 : coming to a complete stop)
...
H_total_experiment_time = 70.0                                                     # Total experiment time in [s] for Hardware
