...
First, it includes and defines. They include libraries for CAN and JrkG2. The CAN_BITRATE is set to 500k, and the CAN_ID is 0x626. There's some conditional compilation for the serial port, using a hardware serial if available, or software serial on pins 10 and 11. The JrkG2Serial object is created for communication.
