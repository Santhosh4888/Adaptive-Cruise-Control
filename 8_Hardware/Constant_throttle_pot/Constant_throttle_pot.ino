...
float desired_voltage = 0;        // Input will be obtained from the user
...
unsigned long test_time = 50000;                 // Sends throttle pot signal to the motor controller for this time (in milliseconds)
...
void setup() { 
  ...
  switch(choice) {
    ...
    delay(1000);
    read_params();
    while(true);#include <Arduino_CAN.h>
