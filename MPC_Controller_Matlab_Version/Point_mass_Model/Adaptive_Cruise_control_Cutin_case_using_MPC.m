...
% Simulating a scenario where the controller sees the lead vehicle at a distance of 10m
% sensor and systems reaction combined takes whole 3sec and after that 
% vehicle starts decelerating as per requirement and starts following the lead vehicle at safe headway distance.
...
%% Initial Conditions
x_lead = 10;                 % Lead vehicle initial position (m)
x_ego = 0;                    % Ego vehicle initial position (m)
v_ego = 5;                    % Ego vehicle initial speed (m/s)
