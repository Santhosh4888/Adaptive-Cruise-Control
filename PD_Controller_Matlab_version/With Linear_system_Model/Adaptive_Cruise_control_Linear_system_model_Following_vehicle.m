% Following a Lead Vehicle Scenario which is moving with constant
% acceleration at a certain distance at speed lower the ego vehicle
...
x_lead = 100;      % Initial position of lead vehicle (m)
