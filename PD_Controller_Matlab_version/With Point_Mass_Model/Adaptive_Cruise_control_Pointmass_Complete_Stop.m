...
% Parameters
v_lead = 0;     % Lead vehicle speed (m/s)
...
v_max_ego = 5.56;  % Maximum velocity of the ego vehicle (m/s)
x_lead = 300;      % Initial position of lead vehicle (m)
...
a_current = 0;     % Current acceleration of the vehicle (m/s²)
